...
- `staleArchiveSlots`: archive slots that disappeared or became stale.
- `blockedUnsafeRestores`: unsafe restore attempts blocked by the script.
...
This resets local config/diagnostics and restores archived messages when possible.
